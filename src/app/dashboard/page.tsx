      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-[#EAE3DA] pb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 rounded-full bg-[#C1785A] hover:bg-[#A86347] text-[#FAF6F0] text-xs sm:text-sm font-bold uppercase tracking-[0.15em] shadow-warm hover:shadow-warm-lg transition-all transform hover:-translate-y-0.5"
          >
          ...
          <Link
            href="/scan"
            className="flex items-center gap-2 px-4 py-3 rounded-full bg-[#F5E6DF] hover:bg-[#E8D8CE] border border-[#E8D0C5] text-xs sm:text-sm font-bold uppercase tracking-[0.15em] text-[#8C462C] transition-colors shadow-sm"
          ...
          <Link
            href="/analytics"
            className="flex items-center gap-2 px-4 py-3 rounded-full bg-[#F3ECE3] hover:bg-[#EAE3DA] border border-[#EAE3DA] text-xs sm:text-sm font-bold uppercase tracking-[0.15em] text-[#2C2725] transition-colors shadow-sm"
          ...
          <button
            ...
            className="p-3 rounded-full bg-[#F3ECE3] hover:bg-[#EAE3DA] border border-[#EAE3DA] text-[#6E6663] hover:text-[#2C2725] transition-colors shadow-sm"
          >
