...
export function Footer() {
	return (
		<footer className="relative w-full max-w-7xl mx-auto flex flex-col items-center justify-center rounded-t-[40px] md:rounded-t-[56px] border-t border-[#C1785A]/30 bg-[#1F1B19] text-[#FAF6F0] px-6 py-12 lg:py-16 overflow-hidden shadow-2xl">
			{/* Ambient Dark Brown & Terracotta Radial Glow */}
			<div className="absolute inset-0 bg-[radial-gradient(45%_140px_at_50%_0%,rgba(193,120,90,0.22),transparent)] pointer-events-none" />

			{/* Glowing Top Foil Accent Bar */}
			<div className="bg-gradient-to-r from-transparent via-[#C1785A] to-transparent absolute top-0 right-1/2 left-1/2 h-[2px] w-2/3 md:w-1/3 -translate-x-1/2 -translate-y-1/2 rounded-full blur-[1px]" />
