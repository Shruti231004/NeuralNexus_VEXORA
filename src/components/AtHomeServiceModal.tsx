              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-2xl border border-[#EAE3DA] dark:border-[#3A302A] bg-white dark:bg-[#201A18] text-xs font-bold text-[#2C2725] dark:text-[#FAF6F0] focus:outline-none focus:border-[#C1785A]"
                  >
                    <option value="09:00 AM – 11:00 AM (Morning Glow)">09:00 AM – 11:00 AM (Morning Glow)</option>
                    <option value="11:00 AM – 01:00 PM (Peak Styling)">11:00 AM – 01:00 PM (Peak Styling)</option>
                    <option value="02:00 PM – 04:00 PM (Afternoon Spa)">02:00 PM – 04:00 PM (Afternoon Spa)</option>
                    <option value="05:00 PM – 07:00 PM (Soirée Ready)">05:00 PM – 07:00 PM (Soirée Ready)</option>
                    <option value="07:00 PM – 09:00 PM (Late Night Luxe)">07:00 PM – 09:00 PM (Late Night Luxe)</option>
                  </select>
                </div>
